...
namespace GPF.Model
{
    public class Cliente
    {
        ...
        public string cli_conjuge_rg { get; set; }
        ...
        public Cliente(int? cli_id, Endereco end_id, string cli_nome, string cli_sobrenome, string cli_cpf, string cli_rg,
            int cli_casado, string cli_conjuge, string cli_conjuge_cpf, string cli_conjuge_rg,
            DateTime? cli_dtnasc, string cli_telefone1, string cli_telefone2)
        {
            ...
            this.cli_conjuge_rg = cli_conjuge_rg;
